...
export function Galeri() {
  ...
  return (
    <div className="my-container">
      ...
      />
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 md:gap-6 lg:gap-7 [&_img]:rounded-md [&_img]:w-full [&_img]:object-cover [&_img]:object-top [&_img]:shadow-lg [&_img]:border">
        {galeri.map((e, i) => {
          return (
            <div
