  ...
  return (
    <div
      ...
      <div className="md:col-span-8">
        <p className="!text-left text-2xl max-w-xl mb-5 font-extrabold leading-relaxed tracking-wide text-slate-100">
          Pesan travel anda sekarang juga sebelum kehabisan slot!
        </p>
        <p className="!text-left max-w-xl mb-5 text-slate-300 md:mb-0">
